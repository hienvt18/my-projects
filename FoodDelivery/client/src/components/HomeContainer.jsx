    ...
    return (
        <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full" id="home">
            ...
            <p className="text-base text-textColor text-center md:text-left md:w-[80%]">
                ...
                Perferendis ea dolore necessitatibus nisi rerum fuga minus deserunt nesciunt molestiae fugit!
                Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                Repellat non corporis sapiente quam temporibus quis, deleniti cumque cum quos ratione.
            </p>
            <button className="bg-gradient-to-br from-orange-400 to-orange-500 w-full px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-100 ease-in-out md:w-auto">Order Now</button>
            </div>
            ...
            <div className="py-2 flex-1 flex items-center relative">           
                ...
                <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-40 py-4 gap-4 flex-wrap">
                    {heroData.length > 0 && heroData.map(item => (
                        <div key={item.id} className=" lg:w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center drop-shadow-lg">
                            ...
                            <p className="text-[12px] lg:text-sm text-gray-500 my-1 lg:my-2">{item.desc}</p>
