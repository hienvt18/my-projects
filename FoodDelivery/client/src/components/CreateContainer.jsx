    ...
    <div className="w-full min-h-screen h-auto flex items-center justify-center">
      <div className="w-[90%] md:w-[75%] border border-gray-200 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
        ...
        <div className="w-full">
          ...
          >
            <option value="orther" className="bg-white">Select Category</option>
              ...
              {!imageAsset ? 
                <>
                  <label className="w-full h-full flex flex-col items-center justify-center cursor-pointer">
                    ...
                    <input type="file" name="uploadimage" accept="image/" onChange={handleUploadImage} className="w-0 h-0" />
                  </label>
                </> 
                : <>
        ...
        <div className="flex items-center w-full ">
          <button 
            ...
            text-lg text-white font-semibold" onClick={handelSaveDetails}
          >
            Save
            </button>
        </div>
